...
const projects = [
  ...
  { id: 2,  title: 'Patient Summary Generator', section: 'healthcare',     status: 'Active', url: '/healthcare/patient-summary',   tags: ['Patient Care','PDF Generation','Discharge Summary'],            description: 'Generate comprehensive patient discharge summaries in PDF format with secure data handling.',                             previewImages: ['/Patient-summary.png'],  lastUpdated: '1 hour ago',  members: 6  },
  { id: 3,  title: 'Medical Assistant',         section: 'healthcare',     status: 'Active', url: '/healthcare/medical-assistant', tags: ['AI Assistant','Diagnostics','Medical Support'],                 description: 'AI-powered medical assistant for healthcare professionals with advanced diagnostic support.',                             previewImages: ['/Medical-1.png','/Medical-2.png','/Medical-3.png'],   lastUpdated: '30 min ago',  members: 12 },
  { id: 4,  title: 'Health Platform',           section: 'healthcare',     status: 'Active', url: '/healthcare/health',            tags: ['Healthcare Platform','Patient Management','Health Monitoring'], description: 'Comprehensive healthcare management system with integrated patient care and medical records.',                            previewImages: ['/Health-1.png','/Health-2.png','/Health-3.png'], lastUpdated: '15 min ago',  members: 10 },
  { id: 5,  title: 'Smart Documents',           section: 'education',      status: 'Active', url: '/Education/smart-documents',    tags: ['AI Processing','Validation','Document Analysis'],               description: 'AI-powered document analysis, validation, and automated application processing with real-time dashboard.',               previewImages: ['/Smart-document.png','/Smart-document-1.png'],   lastUpdated: '1 hour ago',  members: 8  },
  ...
  { id: 10, title: 'VoiceBot - CloudTutor',     section: 'other',          status: 'Inactive', url: '/other/voicebot',               tags: ['Voice AI','Gemini Live','Education','Real-time'],               description: 'Real-time AI voice assistant powered by Gemini 2.5 Live for Google Cloud Platform tutoring.',                            previewImages: ['/Voicbotai.png'],                                lastUpdated: '1 hour ago',  members: 5  },
  { id: 11, title: 'Smart Policy Processor',    section: 'fintech',        status: 'Active', url: '/transportation/smart-policy',  tags: ['Insurance','PDF Extraction','Policy Processing'],               description: 'AI-powered insurance policy document processor that extracts structured data from PDF policies.',                        previewImages: ['/Smart-policy-1.png','/Smart-policy-2.png'],  lastUpdated: '1 hour ago',  members: 5  },
  { id: 12, title: 'Security Platform', section: 'security', status: 'Active', url: '/security', tags: ['Security','Monitoring','AI Analysis'], description: 'AI-powered security monitoring and analysis platform for threat detection and incident response.', previewImages: ['/Security.png'], lastUpdated: '1 hour ago', members: 6 },
  { id: 13, title: 'ConvoGen AI',               section: 'other',          status: 'Active', url: '/other/convogenai',              tags: ['Conversational AI','NLP','Generation'],                          description: 'AI-powered conversational generation platform for building intelligent dialogue systems.',                              previewImages: ['/Convogen-1.png','/Convogen-2.png'], lastUpdated: '1 hour ago',  members: 5  },
];
